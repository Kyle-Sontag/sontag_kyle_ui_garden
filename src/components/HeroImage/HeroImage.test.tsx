...
describe('HeroImage', () => {
  ...
  test('changes background colour when disabled', () => {
    const { rerender } = render(<HeroImage src="https://placehold.co/1200x400" alt="Test Hero" backgroundColor="#000000"/>);
    const element = screen.getByTestId('hero-image');

    expect(element).toHaveStyle('background-color: #000000');

    rerender(<HeroImage src="https://placehold.co/1200x400" alt="Test Hero" backgroundColor="#000000" disabled={true}/>);
